          ...
          <div className="bg-white rounded-xl border border-gray-200 p-8">
            ...
            <div className="border-2 border-dashed border-green-200 bg-green-100 rounded-lg p-6 hover:bg-green-200 transition-colors cursor-pointer">
              <div className="flex flex-col items-center justify-center">
                <input type="file" id="image" className="hidden" accept="image/*" ref={image} onChange={(e) => setFileName(e.target.files?.[0]?.name || "")} />
                <label htmlFor="image" className="cursor-pointer"><Upload /></label>
